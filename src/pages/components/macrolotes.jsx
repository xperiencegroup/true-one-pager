              ...
              return (
                ...
                >
                  <img
                    src={decoration}
                    alt=""
                    className="lg:hidden h-[41px] brightness-0 invert-100"
                  />

                  <div className="relative flex flex-col pl-[30px] gap-[15px] max-lg:before:hidden before:absolute before:left-0 before:top-0 before:h-[82.5px] before:w-[1.5px] before:bg-gradient-to-b before:from-white before:via-white before:to-transparent">
                    <h3 className="paragraph max-lg:text-center text-white font-bold">
                      {beneficio.title}
                    </h3>
