...
export default function Navbar() {
  ...
  return (
    <div className="navbar-enter relative z-50 flex w-full justify-center bg-blue">
      <div className="relative flex w-full h-[83px] justify-between min-[660px]:justify-center lg:justify-around items-center max-[660px]:p-[20px]">
        {/* Botón Logo True */}
