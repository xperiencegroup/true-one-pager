  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute z-10 top-[23px] right-[24px] flex items-center justify-center size-[52px] rounded-full bg-cream hover:opacity-90 hover:cursor-pointer"
        >
          <img src={closeIcon} alt="Cerrar" className="size-[26px]" />
        </button>
